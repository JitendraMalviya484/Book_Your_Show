...
@NoArgsConstructor
@ToString
@ApiModel(value = "Edit Booking Request Dto")
public class EditBookingDto implements Serializable{
	...
	private String optionalBookingId;
	private String optionalContactNumber;
